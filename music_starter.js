...
function draw_one_frame(words, vocal, drum, bass, other, counter) {
  ...
  textSize(30)
  textFont('Catalish Huntera');
  text('Having the time of your life', 100, 175);
  pop()
